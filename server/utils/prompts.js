...
const formativeAssessmentPart = ({ subject, topic, duration }) => {
  return ` write max 3 formative assessment Activity for topic of ${topic} of subject ${subject} , the class duration is ${duration},just the question dont add any introduction and Do not use bullet points, asterisks, or special symbols also Make sure the response is formatted no extra symbols or headings
